...
const projects = [
  {
    id: 1,
    titleKey: 'proyek.title1',
    descKey: 'proyek.desc1',
  ...
  {
    id: 2,
    titleKey: 'proyek.title2',
    descKey: 'proyek.desc2',
  ...
  {
    id: 3,
    titleKey: 'proyek.title3',
    descKey: 'proyek.desc3',
  ...
  {
    id: 4,
    titleKey: 'proyek.title4',
    descKey: 'proyek.desc4',
  ...
  {
    id: 5,
    titleKey: 'proyek.title5',
    descKey: 'proyek.desc5',
    tech: ['Laravel', 'MySQL', 'Vite', 'Tailwind'],
    image: '🏫',
...
function ProjectCard({ project, index }) {
  ...
  return (
    ...
    >
      <div
        className={`h-1.5 bg-gradient-to-r ${project.color} animate-gradient`}
  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-1/4 right-20 w-50 h-50 bg-mac-yellow/5 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: '1s' }}
        />
        <div
          className="absolute bottom-1/4 left-20 w-50 h-50 bg-mac-pink/5 rounded-full blur-3xl"
          ...
          <div className="p-6 md:p-10">
            ...
            <div className="mt-6 bg-mac-bg/40 rounded-lg p-3 md:p-4 border border-mac-border/30">
              <div className="flex items-center gap-2 text-[10px] md:text-xs text-mac-text-dim">
                ...
                <span className="text-mac-text-dim/40 ml-2 hidden sm:inline">
                  {t('proyek.cmd_suffix')}
                </span>
              </div>
